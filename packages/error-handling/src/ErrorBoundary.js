...
const logger = (0, logger_1.getLogger)({ name: 'error-boundary' });
        ...
        if (this.state.hasError) {
          ...
          <div className="bg-white rounded-lg shadow-xl p-8 max-w-md w-full">
            <div className="text-center">
              ...
              {this.state.errorId && (<div className="bg-gray-50 rounded p-3 mb-6">
              ...
              <div className="space-y-2">
                {this.state.recoveryAttempts < this.MAX_RECOVERY_ATTEMPTS && (<button onClick={this.handleRetry} className="w-full bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors">
                    Try Again
                  </button>)}

                <button onClick={() => window.location.reload()} className="w-full bg-gray-200 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-300 transition-colors">
                  Reload Page
                </button>
              </div>
            </div>
