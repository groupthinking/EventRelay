const { createExampleJobRef, recordExampleEventRef, deleteExampleEventRef, listVideoJobsRef, getVideoJobRef, listJobEventsRef, listVideoEmbeddingsRef, listFailedJobsRef, connectorConfig } = require('../index.cjs.js');
