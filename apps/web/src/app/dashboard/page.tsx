...
// The pipeline is linear (ingest → transcribe → analyze → extract); the UI
// mirrors that single backend lifecycle, with no synthetic agent stages.
const STAGES = ['Ingest', 'Transcribe', 'Analyze', 'Extract'] as const;
