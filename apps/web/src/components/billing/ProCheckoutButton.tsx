  ...
  return (
    <div className="space-y-3">
      ...
      <button
        ...
        className={clsx(
          'btn btn-primary w-full py-3.5 text-center text-sm shadow-lg shadow-primary-500/30 focus-visible:ring-2 focus-visible:ring-teal-200 focus-visible:ring-offset-2 focus-visible:ring-offset-surface-950',
