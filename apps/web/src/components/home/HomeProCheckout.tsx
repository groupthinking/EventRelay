    ...
    >
      ...
      <div className="mt-5 inline-flex rounded-2xl border border-white/[0.08] bg-white/[0.04] p-1.5">
        <button
          ...
          aria-pressed={!annual}
          className={`rounded-xl px-5 py-2 text-sm font-semibold transition focus-visible:ring-2 focus-visible:ring-teal-200 focus-visible:ring-offset-2 focus-visible:ring-offset-surface-950 ${!annual ? 'bg-white/[0.1] text-white' : 'text-white/40'}`}
        >
          Monthly checkout
        </button>
        <button
      ...
      <p className="mt-4 text-center">
        <Link
          href="/pricing"
          className="rounded-sm text-sm text-white/55 underline-offset-4 hover:text-white/80 hover:underline focus-visible:ring-2 focus-visible:ring-teal-200 focus-visible:ring-offset-2 focus-visible:ring-offset-surface-950"
        >
          See all plans
        </Link>
      </p>
