  ...
  return (
    <div className="space-y-5">
      ...
      >
        ...
        <button
          type="submit"
          className="px-4 py-2.5 font-heading font-bold text-xs tracking-wider uppercase transition-all disabled:opacity-30 active:scale-95 rounded-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-white/50 flex items-center justify-center min-w-[50px]"
