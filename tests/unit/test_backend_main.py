...
class TestExceptionHandlers:
    ...
    async def test_global_exception_handler_is_sanitized(self):
        """The 500 body must not leak the exception message or class name (CWE-209)."""
        import json as _json
