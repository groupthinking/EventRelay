...
| `gh-aw-validation.yml` | **ADD** | Adds pinned gh-aw (`v0.84.2`) validation for EventRelay's custom markdown workflows. Enforces compile/validate plus actionlint, zizmor, and poutine checks, and verifies committed lock files. |
