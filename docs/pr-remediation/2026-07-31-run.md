...
> **Historical as of 2026-07-31. Superseded in part — do not action the retired
> agent-completion gate items below.** The gate was retired in #1434 (closing #1432).
...
repo-defined agent-completion governance check. The gate's
...
| PR | Author | Title | CI (functional) | Retired gate (historical) | Draft | Terminal state |
|----|--------|-------|-----------------|-----------|-------|----------------|
...
1. ~~Provide the retired gate's *historical provenance disposition* (or relax the gate
...
```
# Fully green dependabot bump, retired gate not-applicable:
...
The retired agent-completion gate workflow was erroring with `invalid_payload` on
