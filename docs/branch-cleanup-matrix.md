...
tip fully contained in `main` (zero unique work to lose) · **CLOSE-STALE**: no PR, stale,
superseded, won't merge clean · **REVIEW**: no PR but recent/unique — needs a human glance.
