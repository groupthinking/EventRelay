...
class EnhancedMCPServer:
    ...
    def _register_tools(self) -> None:
        ...
        async def extract_video_content(arguments: Dict[str, Any]) -> CallToolResult:
        ...
        @self.server.call_tool()
        async def get_youtube_transcript(arguments: Dict[str, Any]) -> CallToolResult:
        ...
        @self.server.call_tool()
        async def create_video_notebook(arguments: Dict[str, Any]) -> CallToolResult:
        ...
        @self.server.call_tool()
        async def get_video_insights(arguments: Dict[str, Any]) -> CallToolResult:
        ...
        @self.server.call_tool()
        async def analyze_video_content(arguments: Dict[str, Any]) -> CallToolResult:
        ...
        @self.server.call_tool()
        async def categorize_video(arguments: Dict[str, Any]) -> CallToolResult:
        ...
        @self.server.call_tool()
        async def process_video_complete(arguments: Dict[str, Any]) -> CallToolResult:
        ...
        # Utility tools
        @self.server.call_tool()
        async def get_processing_status(arguments: Dict[str, Any]) -> CallToolResult:
        ...
        @self.server.call_tool()
        async def clear_processing_cache(arguments: Dict[str, Any]) -> CallToolResult:
    ...
    def _register_prompts(self) -> None:
        ...
        async def video_analysis_prompt(arguments: Dict[str, Any]) -> GetPromptResult:
        ...
        @self.server.get_prompt()
        async def video_extraction_prompt(arguments: Dict[str, Any]) -> GetPromptResult:
    ...
    async def run_standalone_demo(self) -> None:
