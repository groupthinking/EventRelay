...
Ralph-loop / max completion friendly runner.
"""
import argparse
import asyncio
import json
...
def parse_args():
    p = argparse.ArgumentParser(description="Run Video-to-Software agent pipeline (Ralph Loop mode)")
    ...
    p.add_argument("--mock", action="store_true",
                   help="Force mock-friendly mode (sets USE_MOCK_SERVERS)")
