...
class EnvFileHandler(FileSystemEventHandler):
    ...
    def __init__(self, env_path: Path, validator: EnvValidator) -> None:
...
class PollingMonitor:
    ...
    def __init__(self, env_path: Path, validator: EnvValidator, interval: int = 2) -> None:
        self.env_path = env_path
        self.validator = validator
...
def monitor_with_watchdog(env_path: Path, validator: EnvValidator) -> None:
