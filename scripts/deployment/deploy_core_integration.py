...
class CoreDeploymentManager:
    ...
    async def deploy_core_youtube_integration(self) -> bool:
...
'''
    ...
    async def configure_api_integrations(self) -> bool:
    ...
    async def integrate_nexa_models(self) -> bool:
...
'''
    ...
    async def add_gemini_logprobs_integration(self) -> bool:
...
'''
    ...
    async def define_success_metrics(self) -> bool:
    ...
    async def create_deployment_launcher(self) -> bool:
