...
exports.SPEC_ADDENDUM = exports.CODE_REGION_CLOSER = exports.CODE_REGION_OPENER = exports.SPEC_FROM_VIDEO_PROMPT = void 0;
exports.SPEC_FROM_VIDEO_PROMPT = `You are a pedagogist and product designer with deep expertise in crafting engaging learning experiences via interactive web apps.
...
exports.CODE_REGION_OPENER = '```';
exports.CODE_REGION_CLOSER = '```';
exports.SPEC_ADDENDUM = `\n\nThe app must be fully responsive and function properly on both desktop and mobile. Provide the code as a single, self-contained HTML document. All styles and scripts must be inline. In the result, encase the code between "${exports.CODE_REGION_OPENER}" and "${exports.CODE_REGION_CLOSER}" for easy parsing.`;
