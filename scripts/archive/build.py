...
class ExtensionBuilder:
    ...
    def validate_extension_files(self) -> None:
    ...
    def copy_extension_files(self, target_dir: Path, browser: str) -> None:
    ...
    def generate_icons(self, build_dir: Path) -> None:
    ...
    def create_placeholder_icons(self, icons_dir: Path, sizes: List[int]) -> None:
    ...
    def modify_manifest_for_browser(self, build_dir: Path, browser: str) -> None:
    ...
    def create_safari_background_html(self, build_dir: Path) -> None:
...
<body>
    ...
    def minify_javascript(self, build_dir: Path) -> None:
    ...
    def optimize_css(self, build_dir: Path) -> None:
        """Optimize CSS files"""
    ...
    def validate_build(self, build_dir: Path, browser: str) -> None:
    ...
    def build_api_service(self) -> None:
    ...
    def create_api_deployment_files(self, api_dir: Path) -> None:
...
http {
    ...
    def generate_build_report(self, built_extensions: List[Dict[str, Any]]) -> None:
        """Generate build report"""
        report = {
