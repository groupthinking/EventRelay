...
class EnhancedContinuousRunner:
    ...
    async def save_video_result(self, result: Dict[str, Any], video_id: str) -> None:
    ...
    async def _update_learning_log(self, result: Dict[str, Any]) -> None:
    ...
    async def _log_failure(self, video_id: str, error: str) -> None:
